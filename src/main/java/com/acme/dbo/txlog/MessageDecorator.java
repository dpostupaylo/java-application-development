...
public class MessageDecorator {
    ...
    public static String decorate(int message) { return PRIMITIVE_PREFIX + message; }
    ...
    public static String decorate(String message) { return STRING_PREFIX + message; }
    ...
    public static String decorate(Object message) {
        return REFERENCE_PREFIX + message.toString();
    }
